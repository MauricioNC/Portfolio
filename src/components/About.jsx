...
function About() {
  return (
    <section
      ...
      <div className='flex flex-row justify-start items-centes'>
      ...
      <article className='grid grid-cols-1 gap-4 xl:grid-cols-6 place-items-center'>
        <div className='[&>p]:mb-4 [&>p>strong]:text-[crimson] [&>p]:text-pretty xl:col-span-4 order-2'>
          <p>
        ...
        <figure className='aspect-square w-[280px] mb-4 md:mb-0 overflow-clip rounded-full ring-2 ring-[crimson] p-2 shadow-[5px_5px_10px_0px_#0f0f0f] md:col-span-2 place-self-start order-1'>
          <img
            src={about}
